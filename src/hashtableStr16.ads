...
generic
   tableSize: Integer;
   useRandomProbe: Boolean; --Select to use random or linear probe.
package HashTableStr16 is
   ...
   function GenerateBadHashAddress(aKey: in String) return Integer;                --HashFunction Specified in Lab
