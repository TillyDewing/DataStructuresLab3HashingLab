pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b__testmain.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b__testmain.adb");
...
package body ada_main is
   ...
   E138 : Short_Integer; pragma Import (Ada, E138, "system__direct_io_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "system__direct_io__finalize_spec");
      begin
         F1;
      end;
      E094 := E094 - 1;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_testmain");
...
--  BEGIN Object file/option list
   --   C:\GNAT\2021\bin\HashingLab\obj\testmain.o
