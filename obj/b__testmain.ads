...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_testmain" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#53d58bdc#;
   pragma Export (C, u00001, "testmainB");
   ...
   u00137 : constant Version_32 := 16#0f9a77f5#;
   pragma Export (C, u00137, "system__direct_ioB");
   u00138 : constant Version_32 := 16#8d9bb72a#;
   pragma Export (C, u00138, "system__direct_ioS");
